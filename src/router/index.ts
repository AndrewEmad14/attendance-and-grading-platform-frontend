    ...
    children: [
      {
        ...
        meta: { title: 'Component Blueprint Playground', allowedRoles: ['branch_manager', 'track_admin', 'instructor', 'student'] }
      },
      {
        path: 'analytics',
        name: 'BranchInsights',
      ...
      },
      {
        ...
        meta: { title: 'Engagement Calendar', allowedRoles: ['track_admin', 'instructor', 'student'] }
      },
      {
        path: 'attendance',
      ...
      },
      {
        ...
        meta: { title: 'Performance Gradebook', allowedRoles: ['track_admin', 'instructor', 'student'] }
      },
      {
        path: 'submissions',
        name: 'MyDeliverables',
      ...
      },
      {
        ...
        meta: { title: 'Cohort Announcements', allowedRoles: ['track_admin', 'instructor', 'student'] }
      },
      {
        path: 'users',
        name: 'SystemUsers',
