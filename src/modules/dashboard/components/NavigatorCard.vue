...
<template>
  ...
  >
    ...
    <div class="min-w-0">
      <h3 class="font-bold text-surface-900 text-sm tracking-tight flex items-center gap-1">
        {{ label }}
        <i
          class="pi pi-arrow-right text-[10px] text-surface-300 group-hover:text-primary transition-all duration-200 group-hover:translate-x-0.5"
        ></i>
      </h3>
