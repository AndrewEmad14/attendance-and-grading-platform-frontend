  ...
  <div class="min-h-screen w-full flex items-center justify-center bg-zinc-50 p-4 font-sans">
    <div class="w-full max-w-md bg-white border border-zinc-200/80 rounded-lg p-8 shadow-xs">
      ...
      <div v-else>
        ...
        <div v-if="!form.token || !form.email"
          class="mb-4 p-3 bg-warning border border-warning-border text-warning-content text-sm rounded-md flex items-center gap-2">
        ...
        <form @submit.prevent="handleResetPassword" novalidate class="space-y-5">
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="relative w-full">
              ...
              <button type="button" @click="showPassword = !showPassword"
                ...
                :aria-label="showPassword ? 'Hide password' : 'Show password'" :disabled="!form.token || !form.email">
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <p v-if="errors.password_confirmation" class="text-xs text-danger-content mt-1">{{
